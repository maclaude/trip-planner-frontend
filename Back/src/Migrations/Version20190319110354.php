 ...
 */
final class Version20190319110354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vote_project_dates ADD project_dates_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vote_project_dates DROP project_dates_id');
    }
}
